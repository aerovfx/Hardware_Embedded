# Tuần 5: Lắp Ráp Hoàn Chỉnh & Bay Thử / Week 5: Full Assembly & First Flight

## Mục Tiêu / Learning Objectives
1. Nắm rõ sơ đồ nối dây tổng thể / Complete wiring diagram for the full drone.
2. Quản lý dây cáp an toàn / Cable management: zip ties, heat shrink, routing away from props.
3. Cân bằng trọng tâm drone / Center of gravity calculation and balancing.
4. Kiểm tra an toàn trước bay / Pre-flight checklist: 15-point inspection.
5. Cấu hình bước cuối trong Betaflight / Betaflight final config.
6. Kỹ năng bay lơ lửng thử nghiệm / Maiden flight protocol: tethered hover test first.
7. Xử lý sự cố / Crash assessment.

## Linh Kiện & Công Cụ / Components & Tools
| Tên (VI) | Name (EN) | Số lượng / Qty | Ghi chú / Notes |
| --- | --- | --- | --- |
| Drone hoàn chỉnh | Assembled Drone | 1 | Từ các bài trước |
| Dây buộc (Tether) | Tether cord | 1 | |
| Dây thít nhựa | Zip ties | Nhiểu | |

## Lý Thuyết / Theory

### Complete wiring diagram
Sơ đồ mạch hoàn chỉnh kết nối PDB, ESC, FC, Motors, RX.
> [!NOTE]
> Thông tin bổ sung: Hãy luôn chú ý đến chi tiết này.
> Additional info: Always pay attention to this detail.

### Cable management
Routing away from props. Dùng zip ties để cố định cáp vào frame.

### Center of gravity calculation
Trọng tâm phải cân bằng giữa 4 trục để PID hoạt động hoàn hảo.

### Pre-flight checklist
15-point inspection. Bao gồm cả việc kiểm tra ốc vít có lỏng không.

### Betaflight final config
Motor direction test, prop direction, accelerometer calibration.

### Maiden flight protocol
Tethered hover test first. Bay lơ lửng có dây giữ an toàn.

### Trim and fine-tuning basics
Điều chỉnh PID và các thông số bay.

### Reading flight data
Betaflight blackbox introduction.

### Crash assessment
What to check after a crash. Hư hỏng vật lý, chập điện, v.v.

### Emergency procedures
Kill switch, flyaway prevention.

## Thực Hành / Hands-On Practice

### Bước 1: Full assembly of drone / Step 1: Lắp ráp cuối cùng
Bó gọn dây cáp.
**⚠️ LƯU Ý / NOTE:** Thực hiện chậm rãi và kiểm tra kỹ.

### Bước 2: Tethered hover test first / Step 2: Bay thử có dây an toàn
**⚠️ CẢNH BÁO AN TOÀN / SAFETY WARNING:** Cánh quạt quay với tốc độ cực cao, có thể gây đứt tay! Luôn giữ khoảng cách an toàn. / Props spin at extremely high speeds and can cause severe cuts! Always maintain a safe distance.

### Bước 3: First free hover / Step 3: Bay tự do
Thử nghiệm trên bãi cỏ mềm.

## Code / Formulas
```markdown
CG_X = Sum(Weight_i * X_i) / Total_Weight
CG_Y = Sum(Weight_i * Y_i) / Total_Weight
```

## Câu Hỏi Thảo Luận / Discussion Questions
1. Tại sao phải bó cáp gọn gàng? / Why manage cables neatly?
   - *Gợi ý / Hint: Suy nghĩ về cánh quạt.*
2. Cần làm gì đầu tiên khi drone rơi? / What to do first when crashing?
3. Tính năng Blackbox trong Betaflight dùng để làm gì? / What is Blackbox used for?
4. Tethered test an toàn hơn ở điểm nào? / Why is tethered testing safer?
5. Kill switch hoạt động như thế nào? / How does the kill switch work?

## Bài Về Nhà / Homework
- **Nhiệm vụ 1 / Task 1:** Ghi chép nhật ký bay / Write a flight log.
- **Nhiệm vụ 2 / Task 2:** Phân tích dữ liệu Blackbox cơ bản.

## Đánh Giá / Assessment Rubric
| Tiêu chí / Criteria | Xuất sắc / Excellent (9-10) | Khá / Good (7-8) | Đạt / Pass (5-6) | Cần cố gắng / Needs Work (<5) |
| --- | --- | --- | --- | --- |
| Lắp ráp hoàn thiện | Hoàn hảo | Rất tốt | Tốt | Tạm được |
| An toàn bay | Tuân thủ 100% | Có chú ý | Có nhắc nhở | Không tuân thủ |
